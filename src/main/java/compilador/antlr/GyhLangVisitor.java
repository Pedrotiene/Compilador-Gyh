...
public interface GyhLangVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link GyhLangParser#expressaoBooleana}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExpressaoBooleana(GyhLangParser.ExpressaoBooleanaContext ctx);
	/**
	 * Visit a parse tree produced by {@link GyhLangParser#fatorBooleano}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFatorBooleano(GyhLangParser.FatorBooleanoContext ctx);
	/**
	 * Visit a parse tree produced by {@link GyhLangParser#comparacao}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitComparacao(GyhLangParser.ComparacaoContext ctx);
	/**
	 * Visit a parse tree produced by {@link GyhLangParser#opRelacional}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOpRelacional(GyhLangParser.OpRelacionalContext ctx);
}