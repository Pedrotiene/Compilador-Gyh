...
public interface GyhLangListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link GyhLangParser#expressaoBooleana}.
	 * @param ctx the parse tree
	 */
	void enterExpressaoBooleana(GyhLangParser.ExpressaoBooleanaContext ctx);
	/**
	 * Exit a parse tree produced by {@link GyhLangParser#expressaoBooleana}.
	 * @param ctx the parse tree
	 */
	void exitExpressaoBooleana(GyhLangParser.ExpressaoBooleanaContext ctx);
	/**
	 * Enter a parse tree produced by {@link GyhLangParser#fatorBooleano}.
	 * @param ctx the parse tree
	 */
	void enterFatorBooleano(GyhLangParser.FatorBooleanoContext ctx);
	/**
	 * Exit a parse tree produced by {@link GyhLangParser#fatorBooleano}.
	 * @param ctx the parse tree
	 */
	void exitFatorBooleano(GyhLangParser.FatorBooleanoContext ctx);
	/**
	 * Enter a parse tree produced by {@link GyhLangParser#comparacao}.
	 * @param ctx the parse tree
	 */
	void enterComparacao(GyhLangParser.ComparacaoContext ctx);
	/**
	 * Exit a parse tree produced by {@link GyhLangParser#comparacao}.
	 * @param ctx the parse tree
	 */
	void exitComparacao(GyhLangParser.ComparacaoContext ctx);
	/**
	 * Enter a parse tree produced by {@link GyhLangParser#opRelacional}.
	 * @param ctx the parse tree
	 */
	void enterOpRelacional(GyhLangParser.OpRelacionalContext ctx);
	/**
	 * Exit a parse tree produced by {@link GyhLangParser#opRelacional}.
	 * @param ctx the parse tree
	 */
	void exitOpRelacional(GyhLangParser.OpRelacionalContext ctx);
}